...
export const CATEGORIES: CatSeed[] = [
  ...
  { code: "COURIER", name: "Courier / Porter", group: "Logistics & Fulfilment",
  ...
  { code: "FREIGHT", name: "Freight & Transport", group: "Logistics & Fulfilment",
    tallyLedger: "Carriage Outward", costCenters: ALL, monthlyBudget: 4000, sortOrder: 11,
    aliases: ["Transport", "Travel & Transport - Freight"] },
  { code: "PACKAGING", name: "Packaging Material", group: "Logistics & Fulfilment",
  ...
  // ---- Manpower ----------------------------------------------------------
  { code: "STAFF_WELFARE", name: "Staff Food & Tea", group: "Manpower",
  ...
  { code: "STAFF_WAGES", name: "Staff Wages & Labour", group: "Manpower",
  ...
  { code: "HOUSEKEEPING", name: "Housekeeping", group: "Manpower",
  ...
  // ---- Facility ----------------------------------------------------------
  { code: "RENT", name: "Rent", group: "Facility",
  ...
  { code: "UTILITIES", name: "Electricity & Utilities", group: "Facility",
  ...
  { code: "REPAIRS", name: "Repairs & Maintenance", group: "Facility",
  ...
  // ---- Travel ------------------------------------------------------------
  { code: "CONVEYANCE", name: "Local Conveyance", group: "Travel",
  ...
  { code: "TRAVEL_OUT", name: "Outstation Travel & Stay", group: "Travel",
  ...
  // ---- IT & Communication ------------------------------------------------
  { code: "IT_SOFTWARE", name: "Software & Subscriptions", group: "IT & Communication",
  ...
  { code: "IT_EQUIP", name: "IT Equipment & Consumables", group: "IT & Communication",
  ...
  { code: "TELECOM", name: "Internet & Mobile", group: "IT & Communication",
  ...
  // ---- Marketing ---------------------------------------------------------
  { code: "MARKETING", name: "Marketing & Events", group: "Marketing",
  ...
  { code: "SAMPLES", name: "Samples & Giveaways", group: "Marketing",
  ...
  { code: "PROF_FEES", name: "Professional Fees", group: "Professional & Statutory",
  ...
  { code: "STATUTORY", name: "Statutory & Compliance", group: "Professional & Statutory",
  ...
  { code: "BANK_CHARGES", name: "Bank & Payment Charges", group: "Professional & Statutory",
    tallyLedger: "Bank Charges", costCenters: OFFICE, monthlyBudget: 2000, sortOrder: 82,
    aliases: ["Bank Charges", "Payment Gateway", "Bank"] },

  // ---- Capex -------------------------------------------------------------
  { code: "FURNITURE", name: "Furniture & Fixtures (Capex)", group: "Capital Expenditure",
  ...
  { code: "EQUIPMENT", name: "Plant & Equipment (Capex)", group: "Capital Expenditure",
   ...
   */
  { code: "UNCLASSIFIED", name: "Unclassified (re-tag)", group: "Other",
  ...
  { code: "MISC", name: "Miscellaneous", group: "Other",
